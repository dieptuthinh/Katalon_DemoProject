...
public class form {
	private TestObject fName_inp = findTestObject('tc1/Page_ToolsQA/input', [('id'):'firstName'])

	private TestObject lName_inp = findTestObject('tc1/Page_ToolsQA/input', [('id'):'lastName'])

	private TestObject email_inp = findTestObject('tc1/Page_ToolsQA/input', [('id') : 'userEmail'])

	private TestObject mobile_inp = findTestObject('tc1/Page_ToolsQA/input', [('id') : 'userNumber'])

	//	private TestObject gender_cb = findTestObject('demoQA/label_gender', [('value') : gender])
	//	private TestObject gender_cb2 = findTestObject('tc1/Page_ToolsQA/Gender', [('sex') : 'Female'])

	private TestObject DOB_inp = findTestObject('tc1/Page_ToolsQA/input', [('id') : 'dateOfBirthInput'])

	private TestObject year_select = findTestObject('Object Repository/demoQA/select_DOB_year')

	private TestObject month_select = findTestObject('Object Repository/demoQA/select_DOB_month')

	private TestObject day_select = findTestObject('Object Repository/tc1/Page_ToolsQA/date')

	// 1
	private TestObject subject_click = findTestObject('Object Repository/tc1/Page_ToolsQA/subject')
	// 2
	private TestObject subject_inp = findTestObject('tc1/Page_ToolsQA/input', [('id') : 'subjectsInput'])
	...
	private TestObject upload_btn = findTestObject('tc1/Page_ToolsQA/input', [('id') : 'uploadPicture'])
	...
	def enterValue(String fName_value, String lName_value, String email_value, String gender_value, String mobile_value, String year_value,
			String month_value, String subject_value, String hobbies_value, String upload_value, String address_value, String state_value, String city_value, String screenshot) {
		'Fill in Name fields'
		...
		WebUI.takeScreenshot('C:\\Users\\dtthinh\\Katalon Studio\\BT\\BT\\Screenshot\\tc2.png')
	}
}
